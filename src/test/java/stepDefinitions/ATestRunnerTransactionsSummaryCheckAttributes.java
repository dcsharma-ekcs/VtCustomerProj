...
@CucumberOptions(
        ...
        ,tags= "@smoke"
        ,monochrome = true
        ,plugin = {"pretty", "html:target/HtmlReports/initiateTransactionsCheckAttributesPhysicalProduct.html"
        ,"json:target/JsonReports/jsonReports.json"
        ,"junit:target/JunitReports/junitReports.xml"}
)

public class ATestRunnerTransactionsSummaryCheckAttributes {
}
